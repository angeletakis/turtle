...
execute_process(
  COMMAND "/usr/bin/git" show-ref "95c63867bf0f6497825ef6cf44a7d0791bd25883"
  WORKING_DIRECTORY "/home/alex/turtle/_deps/ctre-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/95c63867bf0f6497825ef6cf44a7d0791bd25883")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "95c63867bf0f6497825ef6cf44a7d0791bd25883")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "95c63867bf0f6497825ef6cf44a7d0791bd25883")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/hanickadot/compile-time-regular-expressions.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/alex/turtle/_deps/ctre-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/alex/turtle/_deps/ctre-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
